...
// AuthUseCase defines interface for authentication use cases
...
// VenueUseCase defines interface for venue use cases
...
// BookingUseCase defines interface for booking use cases
